  ...
  return (
    <div className={styles.page}>
      <div className={styles.card}>
        <div className={styles.icon}><Shield size={36} /></div>
        <h1 className={styles.title}>Admin Login</h1>
        <p className={styles.subtitle}>Revenue Services Platform — Administration</p>
        ...
        <Link to="/officer/login" className={styles.switchLink}>Officer login →</Link>
